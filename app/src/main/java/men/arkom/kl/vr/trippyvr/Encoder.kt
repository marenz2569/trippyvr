...
internal class Encoder {
    ...
    fun init() {
        ...
        val mediaFormat =
            MediaFormat.createVideoFormat(MIME_TYPE, CameraPreview.eyeSize.width, CameraPreview.eyeSize.height)
        val videoCapabilities = encoder.codecInfo.getCapabilitiesForType(MIME_TYPE).videoCapabilities
